...
def main():
    ...
    validate(val_loader, model_ffn, criterion, args)
    save_state_dict(model_ffn.state_dict(), args.save_path, 'alexnet_bn_conv_e30.pth')
    ...
    upbn(train_loader, model_ffn, criterion, optimizer, args, 1000)
    validate(val_loader, model_ffn, criterion, args)
    save_state_dict(model_ffn.state_dict(), args.save_path, 'alexnet_bn_conv_fc_e30.pth')
